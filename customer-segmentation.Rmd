...
Looking at the graph below the tot.wininss value decreases as k increases, and at k=3 we can see an 'elbow', indicating that whilst clusters beyond this point have decreasing variance, the rate of change of variance has dropped so k=3 is a good number of clusters.
